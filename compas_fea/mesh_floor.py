...
mdl = Structure(name='mesh_floor', path='D:/Temp/')
...
# Loads
mesh_ = compas_rhino.geometry.RhinoMesh.from_guid(rs.ObjectsByLayer('load_mesh')[0]).to_compas()
mdl.add([
    ...
    TributaryLoad(mdl, name='load_area', mesh=mesh_, z=-2000),
])
...
mdl.analyse_and_extract(software='opensees', fields=['u', 's', 'cf'], components=['ux', 'uy', 'uz', 'smises', 'cfx', 'cfy', 'cfz'])
